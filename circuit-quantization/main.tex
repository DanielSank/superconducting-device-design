...
Let's go back to a classical oscillator and assume that we will have harmonic oscillator modes. In such a mode, the node fluxes will oscillate, so we can write the ansatz
\begin{equation}
\vec{\Phi}(t) = \vec{\Phi}_0 e^{i\omega t}
\end{equation}
